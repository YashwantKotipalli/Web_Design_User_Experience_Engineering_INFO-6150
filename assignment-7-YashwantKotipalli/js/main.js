    ...
    .subscribe(e => {
        if (e.code == "Enter") {
            ...
            try {
                ...
                // VALIDATION CHECKS FOR THE ENTERED VALUES
...
// rxjs code to check the contents fo the entered values
...
// EXTACTING THE FORMULA METADATA
// PERFORMING THE FORMULA OPERATIONS ON THE CURRENT VALUES ENTERED BY THE USER
// Updating the fields with the perofmed operations values from the user input
//  Replacing the user input with the caluclated value according to the operation
// displaying the formula on double cliking into the cell 
        ...
        if (e.code == "Tab") {
            for (let [k, v] of spreadsheet.formulaMap) {
                ...
                if (v.startsWith('=SUM(')) {
                    ...
                    // checking for invalid inputs and displaying the INVALID! message
