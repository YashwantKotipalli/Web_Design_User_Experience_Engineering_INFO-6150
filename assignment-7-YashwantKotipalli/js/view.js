...
// spreadsheet class to create the spreadsheet contents and layout
...
class Spreadsheet {
    ...
    // functionality for the add column button
    ...
    //functionality for adding rows in the spreadsheet using the add row button
    addRow(){
    ...
    // deletion happens from the ending
    // if the previous column is deleted, then the data of the last or column next to it gets transfered to the previous column
    ...
    // deletion happens from the ending
    // if the previous row is deleted, then the data of the last or row next to it gets transfered to the previous row
    ...
    // functionality for deleting the row using the delete row button
    delRow(){
        //console.log(this.selectedRow);
        let spreadsheet_1 = document.getElementById("spreadsheet_1");
    ...
    // deleting the column functonality using the delete column button 
    delColumn(){       
        let spreadsheet_1 = document.getElementById("spreadsheet_1");
    ...
    // importing any csv file from local desktop
    importCSV(input) {
    ...
    // exporting the created/updated spreadsheet application
    ...
    // functionality to automatically downloaded the exported csv file
    ...
    // nullifying the whole selected row or column and perform the button operations only when a row or column is selected in the application
...
// assigning the functionalities to the buttons and other parts of the spreadsheet
